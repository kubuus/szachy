...
inline ePieceType operator++(ePieceType pc) { return ePieceType(pc + 1); };
...
enum eMoveType {QUIET, DOUBLE_PAWN_PUSH, EN_PASSANT_CAPTURE, K_CASTLE, Q_CASTLE, N_PROMOTION, B_PROMOTION, R_PROMOTION, Q_PROMOTION, 
                CAPTURE, N_PROMOTION_CAPTURE, B_PROMOTION_CAPTURE, R_PROMOTION_CAPTURE, Q_PROMOTION_CAPTURE, NO_TYPE};
enum eSquares {
